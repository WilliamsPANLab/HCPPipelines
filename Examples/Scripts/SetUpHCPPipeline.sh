...
#export FSLDIR=$PI_HOME/ltozzi/fsl_5.0.6
...
export FREESURFER_HOME=$PI_HOME/ltozzi/freesurfer_hcp
source ${FREESURFER_HOME}/SetUpFreeSurfer.sh > /dev/null 2>&1

# Set up specific environment variables for the HCP Pipeline
export HCPPIPEDIR=$PI_HOME/ltozzi/HCPPipeline_3.27.0_sherlock
#export CARET7DIR=$PI_HOME/ltozzi/workbench/bin_rh_linux64
export MSMBINDIR=$PI_HOME/ltozzi/pipeline_tools/MSM-2015.01.14
